...
if (isset($_POST['nome'])) {
    ...
    mysqli_query($conexao,"UPDATE `candidatos` SET `nome` = '$nome', `sexo` = '$sexo', `idade` = '$idade', `profissao` = '$profissao', `realizacoes` = '$realizacoes', `ideias` = '$ideias', `filiacoes` = '$filiacoes', `cargos` = '$cargos' WHERE `candidatos`.`nome` = '$nome'");
    echo"
	<script>
