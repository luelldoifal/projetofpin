...
<html>
<head>
	<title>Atualizar Dados do Candidato</title>
    <meta charset="utf-8">
...
<body>
	...
	<div class="container">
		...
		<div>
				<p>
Nome do candidato:
<input type='text' name='nome' value='".utf8_encode($row['nome'])."' readonly></p>
</p>
<p>
Sexo:
<input type='text' name='sexo' value='".utf8_encode($row['sexo'])."' readonly>
				
</p>
<p>
Idade:
<input type='text' name='idade' value='".utf8_encode($row['idade'])."' readonly>
</p>
<p>
Profissão:
<input type='text' name='profissao' value='".utf8_encode($row['profissao'])."' readonly>
</p>

<p>
Filiações Anteriores:
<input type='text' name='filiacoes' value='".utf8_encode($row['filiacoes'])."' size='100' >
</p>

<p>
Cargos Anteriores:
<input type='text' name='cargos' value='".utf8_encode($row['cargos'])."' size='100' >
</p>

<p>
Realizações em sua vida pública ou profissional:
<input type='text' name='realizacoes' value='".utf8_encode($row['realizacoes'])."' size='100' >
</p>

<p>
Idéias e Propostas:
<input type='text' name='ideias' value='".utf8_encode($row['ideias'])."' size='100' >
</p>
		</div>
<div class='wrapper3'>
