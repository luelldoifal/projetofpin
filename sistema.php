...
<html>
	...
	<body>
		<div class="t5"><h1 class="center">Povo no Poder</h1></div>
		...
		<p style="clear: left" id="center3"><img class="tam2" src="logo.jpg"></p>
		<p id="center2">A Organização PnP (Povo no Poder) deseja fomentar a publicação de informações sobre candidatos aos cargos eletivos na eleição 2018 de forma que suas ideias e propostas sejam melhor conhecidas pela população, desta forma, espera-se que a população possa escolher melhor seus representantes.</p>
